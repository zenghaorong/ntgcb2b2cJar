 ...
 */
@Controller
@RequestMapping("/platform/self/order/afterSale")
public class SelfOrderAfterSaleController {
    ...
    public String detail(@PathVariable String id, HttpServletRequest req) {
        ...
        if (!Strings.isBlank(id)) {
            req.setAttribute("obj", orderAfterMainService.getAfterSaleDetail(id, self_store.getId()));
        } else {
            req.setAttribute("obj", null);
        }
        return "pages/platform/self/order/after/main/detail";
    }
    ...
    public String toSellerHandle(@RequestParam(value = "afterSaleId") String afterSaleId,
        ...
        //自营店铺
        Store_main self_store = storeMainService.fetch(Cnd.where("self", "=", 1));
        Order_after_main orderAfterMain = orderAfterMainService.fetch(Cnd.where("id", "=", afterSaleId).and("storeId", "=", self_store.getId()));
        ...
        return "pages/platform/self/order/after/main/sellerHandle";
    }
     ...
     * @param flag        自定义标识，用于区别卖家的操作，如同意是1，拒绝是2，申请仲裁是3等等，
