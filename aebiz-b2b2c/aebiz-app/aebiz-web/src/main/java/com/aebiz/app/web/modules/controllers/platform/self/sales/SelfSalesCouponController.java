...
@Controller
@RequestMapping("/platform/self/sales/coupon")
public class SelfSalesCouponController {
    ...
    @RequestMapping("")
    @RequiresPermissions("self.sales.coupon")
	public String index(HttpServletRequest req) {
		return "pages/platform/self/sales/coupon/index";
	}
    ...
    public String add(HttpServletRequest req) {
        ...
        return "pages/platform/self/sales/coupon/add";
    }

    @RequestMapping("/addDo")
    @SJson
    @SLog(description = "保存优惠券")
    @RequiresPermissions("self.sales.coupon.add")
    public Object addDo(@RequestParam(value = "tmp_sartAt", required = false) String sartAt, @RequestParam(value = "tmp_endAt", required = false) String endAt, Sales_coupon salesCoupon, HttpServletRequest req) {
		try {
            ...
            salesCoupon.setStoreId("2017060000000001");
    ...
    public String edit(@PathVariable String id,HttpServletRequest req) {
		...
		return "pages/platform/self/sales/coupon/edit";
    }

    @RequestMapping("/editDo")
    @SJson
    @SLog(description = "保存优惠券")
    @RequiresPermissions("self.sales.coupon.edit")
    ...
    @RequiresPermissions("self.sales.coupon.delete")
	...
	public String detail(@PathVariable String id, HttpServletRequest req) {
        ...
        return "pages/platform/self/sales/coupon/detail";
    }
}
