 ...
 */
@Controller
@RequestMapping("/platform/self/goods/publish")
public class SelfGoodsPublishController {
     ...
     */
    @RequestMapping("/add")
    @RequiresPermissions("self.goods.publish")
    public String add(HttpServletRequest req) {
        ...
        return "pages/platform/self/goods/publish/add";
    }
    ...
    @SJson("full")
    @RequiresPermissions("self.goods.publish.add")
    ...
    public Object addDo(Goods_main goods,
        ...
        try {
            ...
            goods.setStoreId("2017060000000001");
            //校验SKU
    ...
    public String spec(@PathVariable("id")String id, @PathVariable(value="sku", required = false)String sku, HttpServletRequest req) {
        ...
        req.setAttribute("areaList", shopAreaManagementService.query(Cnd.NEW()));
        req.setAttribute("memberTypeList", memberTypeService.query(Cnd.NEW()));
        return "pages/platform/self/goods/publish/spec";
    }
    ...
    public Object classes(@PathVariable(value = "pid", required = false) String pid) {
        return storeMainService.getSubGoodsClasses("2017060000000001", pid);
    }
    ...
    public Object frontClassTree() {
        return storeGoodsclassService.query(Cnd.where("storeId", "=", "2017060000000001"));
    }
