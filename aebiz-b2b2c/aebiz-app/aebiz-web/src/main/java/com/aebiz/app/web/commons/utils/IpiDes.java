...
public class IpiDes {
    ...
    private final static String defaultKey = "cjchnws9";

    public static void main(String[] args) throws Exception {
        String data = "{\"userName\":\"admin\",\"userPwd\":\"123456\",\"destAddr\":\"13995279527,13695279527,13599999999\",\"content\":\"测试短信\",\"srcAddr\":\"106572001190000\"}";
