...
@Controller
@RequestMapping("/store/sales/rule/order")
public class StoreSalesRuleOrderController {
    ...
    @RequestMapping("")
    @RequiresPermissions("store.sales.rule.order")
	public String index(HttpServletRequest req) {
        return "pages/store/sales/rule/order/index";
	}
    ...
    public String productIndex(HttpServletRequest req) {
        return "pages/store/sales/rule/order/product";
    }
    ...
    public String add(HttpServletRequest req) {
        ...
        req.setAttribute("ruleList", salesRuleOrderService.query("^(name|limit_priority)$", Cnd.where("storeId", "=", StringUtil.getStoreId()).and("type", "=", "order").and("disabled", "=", false).and("delFlag", "=", false).desc("limit_priority")));
        return "pages/store/sales/rule/order/add";
    }

    @RequestMapping("/addDo")
    @SJson
    @SLog(description = "保存订单促销规则")
    @RequiresPermissions("store.sales.rule.order.add")
    public Object addDo(@RequestParam(value = "tmp_sartAt", required = false) String sartAt, @RequestParam(value = "tmp_endAt", required = false) String endAt, Sales_rule_order salesRuleOrder, HttpServletRequest req) {
		try {
            ...
            salesRuleOrder.setStoreId(StringUtil.getStoreId());
    ...
    public String edit(@PathVariable String id,HttpServletRequest req) {
        ...
        req.setAttribute("ruleList", salesRuleOrderService.query("^(name|limit_priority)$", Cnd.where("storeId", "=", StringUtil.getStoreId()).and("id", "!=", id).and("type", "=", "order").and("disabled", "=", false).and("delFlag", "=", false).desc("limit_priority")));
		req.setAttribute("obj", salesRuleOrderService.fetch(id));
		return "pages/store/sales/rule/order/edit";
    }

    @RequestMapping("/editDo")
    @SJson
    @SLog(description = "保存订单促销规则")
    @RequiresPermissions("store.sales.rule.order.edit")
    ...
    @RequiresPermissions("store.sales.rule.order.delete")
	...
	public String detail(@PathVariable String id, HttpServletRequest req) {
        ...
        return "pages/store/sales/rule/order/detail";
    }
