 ...
 */
@Controller
@RequestMapping("/platform/self/goods/price")
public class SelfGoodsPriceController {
    ...
    @RequestMapping("")
    @RequiresPermissions("self.goods.price")
    public String index(HttpServletRequest req) {
        ...
        return "pages/platform/self/goods/price/index";
    }
    ...
    public Object productsData(@ModelAttribute("goods") Goods_main goods, @ModelAttribute("product") Goods_product product, DataTable dataTable) {
        return goodsProductService.data(dataTable.getLength(), dataTable.getStart(), dataTable.getDraw(), dataTable.getOrders(), dataTable.getColumns(), goods, product, "2017060000000001");
    }
    ...
    @RequiresPermissions("self.goods.price.edit")
    public Object strategyDo(@PathVariable("productId")String productId, @RequestParam("strategy") String strategy, HttpServletRequest req) {
        try {
            ...
            goodsPriceService.updatePriceOnStrategy(priceList, productId, "2017060000000001");
    ...
    @RequiresPermissions("self.goods.price")
    public String add() {
        return "pages/platform/self/goods/price/add";
    }
    ...
    public String edit(@PathVariable String id, HttpServletRequest req) {
        ...
        return "pages/platform/self/goods/price/edit";
    }
    ...
    public String setting(@PathVariable("productId") String productId, HttpServletRequest req) {
        ...
        return "pages/platform/self/goods/price/setting";
    }
    ...
    public Object delete(@PathVariable("id")String id, @PathVariable(value = "priceLevelId", required = false)String priceLevelId, HttpServletRequest req) {
        try {
            goodsPriceService.vDelete(id, priceLevelId, "2017060000000001");
            return Result.success("globals.result.success");
        } catch (Exception e) {
            return Result.error("globals.result.error");
        }
