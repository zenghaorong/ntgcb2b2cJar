package com.aebiz.app.web.commons.shiro.authc.pam;
...
public class AnySuccessfulStrategy extends AbstractAuthenticationStrategy {
    ...
    public AuthenticationInfo afterAttempt(Realm realm, AuthenticationToken token, AuthenticationInfo singleRealmInfo, AuthenticationInfo aggregateInfo, Throwable t) throws AuthenticationException {
        if (singleRealmInfo == null) {
            if (t.getClass().isAssignableFrom(CaptchaEmptyException.class)) {
                throw Lang.makeThrow(CaptchaEmptyException.class, t.getMessage());
            } else if (t.getClass().isAssignableFrom(CaptchaIncorrectException.class)) {
