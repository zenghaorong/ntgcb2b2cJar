 ...
 */
@Controller
@RequestMapping("/store/order/afterSale/refundment")
public class StoreOrderAfterRefundmentController {
    ...
    @RequestMapping("")
    @RequiresPermissions("store.order.afterSale.refundment")
    public String index(HttpServletRequest request) {
        ...
        return "pages/store/order/after/refundment/index";
    }
    ...
    @RequiresPermissions("store.order.afterSale.refundment")
    public String add() {
        return "pages/store/order/after/refundment/add";
    }

    @RequestMapping("/addDo")
    @SJson
    @SLog(description = "Order_after_main",type = Sys_log.TypeEnum.STORE)
    @RequiresPermissions("store.order.afterSale.refundment.add")
    ...
    public String edit(@PathVariable String id, HttpServletRequest req) {
        ...
        return "pages/store/order/after/refundment/edit";
    }

    @RequestMapping("/editDo")
    @SJson
    @SLog(description = "Order_after_main",type = Sys_log.TypeEnum.STORE)
    @RequiresPermissions("store.order.afterSale.refundment.edit")
    public Object editDo(Order_after_refundment orderAfterRefundment, HttpServletRequest req) {
        try {
            orderAfterRefundment.setOpBy(StringUtil.getStoreUid());
    ...
    @SJson
    @SLog(description = "Order_after_main",type = Sys_log.TypeEnum.STORE)
    @RequiresPermissions("store.order.afterSale.refundment.delete")
    ...
    public String detail(@PathVariable String id, HttpServletRequest req) {
        if (!Strings.isBlank(id)) {
            ...
            NutMap nutMap = orderAfterMainService.getAfterSaleDetail(orderAfterRefundment.getAfterSaleId(), StringUtil.getStoreId());
            nutMap.put("orderAfterRefundment", orderAfterRefundment);
            req.setAttribute("obj", nutMap);
        } else {
            req.setAttribute("obj", null);
        }
        return "pages/store/order/after/refundment/detail";
    }
    ...
    public String toFinanceHandle(@RequestParam(value = "refundmentId") String refundmentId,
        ...
        Order_after_refundment orderAfterRefundment = orderAfterRefundmentService.fetch(Cnd.where("id", "=", refundmentId).and("storeId", "=", StringUtil.getStoreId()));
        ...
        return "pages/store/order/after/refundment/financeHandle";
    }
