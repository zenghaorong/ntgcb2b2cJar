 ...
 */
@Controller
@RequestMapping("/store/order/delivery")
public class StoreOrderDeliveryController {
    ...
    @RequestMapping("")
    @RequiresPermissions("store.order.delivery")
    public String index(HttpServletRequest req) {
        ...
        return "pages/store/order/delivery/index";
    }
    ...
    //@RequiresPermissions("store.order.delivery.create")
    ...
    public String detail(@PathVariable String id, HttpServletRequest req) {
        ...
        return "pages/store/order/delivery/detail";
    }
    ...
    @RequiresPermissions("store.order.delivery.delete")
    ...
    public String printDelivery(@PathVariable String id, HttpServletRequest req){
        ...
        return  "pages/store/order/delivery/printDelivery";
    }
    ...
    public String printExpress(@PathVariable String id, HttpServletRequest req){
        ...
        return  "pages/store/order/delivery/printExpress";
    }
   ...
   /* @RequiresPermissions("store.order.delivery.skipPrint")*/
