...
@Controller
@RequestMapping("/platform/self/sales/rule/goods")
public class SelfSalesRuleGoodsController {
    ...
    @RequestMapping("")
    @RequiresPermissions("self.sales.rule.goods")
	public String index(HttpServletRequest req) {
        req.setAttribute("salesCheckStatusEnumValues", SalesCheckStatusEnum.values());
        return "pages/platform/self/sales/rule/goods/index";
	}
    ...
    public String productIndex(HttpServletRequest req) {
        return "pages/platform/self/sales/rule/goods/product";
    }
    ...
    public String brandIndex(HttpServletRequest req) {
        return "pages/platform/self/sales/rule/goods/brand";
    }
    ...
    public String typeIndex(HttpServletRequest req) {
        return "pages/platform/self/sales/rule/goods/type";
    }
    ...
    public String add(HttpServletRequest req) {
        ...
        req.setAttribute("ruleList", salesRuleGoodsService.query("^(name|limit_priority)$", Cnd.where("storeId", "=", "2017060000000001").and("disabled", "=", false).and("delFlag", "=", false).desc("limit_priority")));

        return "pages/platform/self/sales/rule/goods/add";
    }

    @RequestMapping("/addDo")
    @SJson
    @SLog(description = "保存商品规则")
    @RequiresPermissions("self.sales.rule.goods.add")
    public Object addDo(@RequestParam(value = "tmp_sartAt", required = false) String sartAt, @RequestParam(value = "tmp_endAt", required = false) String endAt, Sales_rule_goods salesRuleGoods, HttpServletRequest req) {
		try {
            ...
            salesRuleGoods.setStoreId("2017060000000001");
    ...
    public String edit(@PathVariable String id,HttpServletRequest req) {
		...
		return "pages/platform/self/sales/rule/goods/edit";
    }

    @RequestMapping("/editDo")
    @SJson
    @SLog(description = "保存订单规则")
    @RequiresPermissions("self.sales.rule.goods.edit")
    ...
    @RequiresPermissions("self.sales.rule.goods.delete")
	...
	public String detail(@PathVariable String id, HttpServletRequest req) {
        ...
        return "pages/platform/self/sales/rule/goods/detail";
    }
