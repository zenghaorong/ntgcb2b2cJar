...
!function (e, t) {
        ...
        e.extend(this, {
            ...
            install: function () {
                if (!i.inputEventPatched) {
                    i.inputEventPatched = "0.0.1";
                    var n = !0, r = !1, s = void 0;
                    try {
                        for (var a, o = t.inputsToCheck[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                            var l = a.value;
                            e(document).on("input.inputevent", l, {selector: l}, t.behavesOk).on("change.inputevent", l, {selector: l}, t.misbehaves)
                        }
                    } catch (u) {
                        r = !0, s = u
                    } finally {
    ...
    y.Form = {
        ...
        _reflowUI: function () {
            ...
            t.off(".Parsley"), this._failedOnce ? t.on(o.namespaceEvents(this.options.triggerAfterFailure, "Parsley"), function () {
                e.validate()
            }) : t.on(o.namespaceEvents(this.options.trigger, "Parsley"), function (t) {
                e._eventValidate(t)
            })
    ...
    V.prototype = {
        init: function (e) {
            return this.__class__ = "Parsley", this.__version__ = "2.3.9", this.__id__ = o.generateID(), this._resetOptions(e), this.$element.is("form") || o.checkAttr(this.$element, this.options.namespace, "validate") && !this.$element.is(this.options.inputs) ? this.bind("parsleyForm") : this.isMultiple() ? this.handleMultiple() : this.bind("parsleyField")
        }, isMultiple: function () {
