//$(document).on("click","[data-label]",function(){$(this).addClass("active").siblings().removeClass("active"),num=$(this).index()}),$(document).on("click","[data-check]",function(){$(this).addClass("active")}),$(function(){$(".next").click(function(){var t=$(this).parent().find("input[type=text]");t.val(parseInt(t.val())+1),setTotal()}),$(".prev").click(function(){var t=$(this).parent().find("input[type=text]");t.val(parseInt(t.val())-1),parseInt(t.val())<0&&t.val(0),setTotal()})}),$(document).on("mouseover",".u-stars i",function(){}).on("mouseout",".u-stars i",function(){}).on("click",".u-stars i",function(){$(".u-stars i").css("color","#ccc"),$(this).css("color","#ff7a68").prevAll().css("color","#ff7a68")}),jQuery.fn.limit=function(){var t=$("[limit]");t.each(function(){var t=$(this).text(),i=$(this).text().length,n=$(this).attr("limit");i>n&&($(this).attr("title",t),t=$(this).text(t.substring(0,n)+"...")),$(this).attr("title","")})},$(function(){$(".good-info .info").attr("limit",30),$("[limit]").limit()});
//单选
...
//多选
$(document).on("click","[data-labels]",function(){
...
//	$(".u-stars i").css("color","#ccc");
    ...
    $(this).parent(".u-stars").find("i").css("color","#ccc");
    $(this).css("color","#ef4c51").prevAll().css("color","#ef4c51");
    $(this).parent(".u-stars").next().text(num+"分");
    $(this).parent(".u-stars").next().next().val(num);
})
...
//去商品详情页
function goProductDetail(sku){
   window.location.href="/front/detail?sku="+sku;
}
/**
 * 头部信息
 */
