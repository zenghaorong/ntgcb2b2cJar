...
(function (factory) {
    ...
    function CityPicker(element, options, func) {
        this.func = func;
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    (this.includeDem('county') ? '<a data-count="county">区县</a>' : '') + '</div>' +
        ...
        defineDems: function () {
            var stop = false;
            $.each([PROVINCE, CITY, COUNTY], $.proxy(function (i, type) {
                if (!stop) {
                    this.dems.push(type);
                }
            ...
            code = (
                type === PROVINCE ? 86 :
                    type === CITY ? this.$province && this.$province.find('.active').data('code') :
                        type === COUNTY ? this.$city && this.$city.find('.active').data('code') : code
            );

            districts = $.isNumeric(code) ? Districts[code] : null;
    ...
    $.fn.citypicker = function (option, func) {
        ...
        return this.each(function () {
            ...
            if (!data) {
                ...
                $this.data(NAMESPACE, (data = new CityPicker(this, options, func)));
            }
